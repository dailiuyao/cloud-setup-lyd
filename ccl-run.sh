...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    -x NCCL_HOME="$NCCL_HOME/build" \
    -x MPI_HOME="/opt/amazon/openmpi" \
    -x LD_LIBRARY_PATH="/opt/aws-ofi-nccl/lib:/opt/amazon/openmpi/lib64:$NCCL_HOME/build/lib:/usr/local/cuda/lib64:${LD_LIBRARY_PATH}" \
    -x NCCL_DEBUG="TRACE" \
    -x NCCL_ALGO="TREE" \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/nccl/nccl_all_reduce_tree.log 2>&1
...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/nccl/nccl_all_reduce_ring.log 2>&1
...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/msccl/all-reduce_sum_float_binary-tree_node2_gpu16_mcl8_mck128_i0.log 2>&1
...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/msccl/all-reduce_sum_float_binary-tree_node2_gpu16_mcl8_mck64_i0.log 2>&1
...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/msccl/all-reduce_sum_float_binary-tree_node2_gpu16_mcl8_mck32_i0.log 2>&1
...
mpirun --hostfile ~/hostfile --map-by ppr:8:node \
    ...
    --datatype float \
    --iters 20 \
    --warmup_iters 5 > $SCRIPT_LYD_HOME/logs/msccl/all-reduce_sum_float_binary-tree_node2_gpu16_mcl8_mck16_i0.log 2>&1
